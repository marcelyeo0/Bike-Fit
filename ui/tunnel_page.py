...
from ui.tunnel_worker import TunnelResult, TunnelWorker
from ui.video_view import VideoView
from windtunnel.drag import compare_drag
...
class TunnelPage(QWidget):
    ...
    def _on_slot_selected(self, button_id: int) -> None:
        self._set_active("A" if button_id == 0 else "B")
    ...
    def _set_active(self, slot_name: str) -> None:
        ...
        self._launch.setEnabled(has_video and self._worker is None)
        if has_video:
    ...
    def _on_launch(self) -> None:
        ...
        self._worker = TunnelWorker(slot.frame)
    ...
    def _on_worker_finished(self) -> None:
        ...
        self._launch.setEnabled(self._slots[self._active].source is not None)
